...
<head>
  ...
  <style>
    ...
    .promo, .contact { background: #ffd6e0; padding: 10px; border-radius: 8px; margin: 20px auto; text-align: center; }
    ...
    .name { font-weight: bold; color: #d54f7b; }
...
<body>
  ...
  <div class="audio-player">
    <h2>🎶 Musik Latar</h2>
    <audio controls>
      <source src="audio/amour plastique.mp3" type="audio/mpeg">
